...
<van-grid>
  <van-grid-item icon="add-o" text="添加心得" to='/alladd'/>
  <van-grid-item icon="browsing-history-o" text="心得列表" to='/alllist'/>
  <van-grid-item icon="add-o" text="添加计划" to='/planadd'/>
  <van-grid-item icon="browsing-history-o" text="计划列表" to='/planList'/>
</van-grid>
